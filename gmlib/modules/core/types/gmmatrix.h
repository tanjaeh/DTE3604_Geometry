...
public:
  ...
  void                   setRowHq(const Point<T,n>& c, int i, T e) { hq_cpy_r(c,i); (*this)[i][n]=e; }
  void                   setColHq(const Point<T,n>& c, int i)      { hq_cpy_c(c,i); (*this)[n][i]=T(1); }
  void                   setColHq(const Vector<T,3>& c, int i)     { hq_cpy_c(c,i); (*this)[n][i]=T(0); }
...
public:
  ...
  void                   setColHq(const Point<T,3>& c, int i)  { hq_cpy_c(c,i); (*this)[3][i]=T(1); }
  void                   setColHq(const Vector<T,3>& c, int i) { hq_cpy_c(c,i); (*this)[3][i]=T(0); }
  ...
  // Scaling
  HqMatrix<T,3> operator*(double d) const;
