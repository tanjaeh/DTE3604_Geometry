...
#include <memory>
#include "../../../../demo/hidmanager/standardhidmanager.h"
...
void StandardHidManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<StandardHidManager *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject StandardHidManager::staticMetaObject = { {
    QMetaObject::SuperData::link<HidManager::staticMetaObject>(),
    qt_meta_stringdata_StandardHidManager.data,
    qt_meta_data_StandardHidManager,
    qt_static_metacall,
    nullptr,
    nullptr
} };
