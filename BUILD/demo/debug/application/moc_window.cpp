...
#include <memory>
#include "../../../../demo/application/window.h"
...
void Window::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (Window::*)(const QString & , bool );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Window::signRcPairActiveStateChanged)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (Window::*)(const QString & , const QRectF & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Window::signRcPairViewportChanged)) {
                *result = 1;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Window::signFrameReady)) {
                *result = 2;
                return;
            }
        }
        {
            using _t = void (Window::*)(const QString & , QKeyEvent * );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Window::signKeyPressed)) {
                *result = 3;
                return;
            }
        }
        {
            using _t = void (Window::*)(const QString & , QKeyEvent * );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Window::signKeyReleased)) {
                *result = 4;
                return;
            }
        }
        {
            using _t = void (Window::*)(const QString & , QMouseEvent * );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Window::signMouseDoubleClicked)) {
                *result = 5;
                return;
            }
        }
        {
            using _t = void (Window::*)(const QString & , QMouseEvent * );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Window::signMouseMoved)) {
                *result = 6;
                return;
            }
        }
        {
            using _t = void (Window::*)(const QString & , QMouseEvent * );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Window::signMousePressed)) {
                *result = 7;
                return;
            }
        }
        {
            using _t = void (Window::*)(const QString & , QMouseEvent * );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Window::signMouseReleased)) {
                *result = 8;
                return;
            }
        }
        {
            using _t = void (Window::*)(const QString & , QWheelEvent * );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Window::signWheelEventOccurred)) {
                *result = 9;
                return;
            }
        }
