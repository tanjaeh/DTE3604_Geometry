...
#include <memory>
#include "../../../../demo/application/guiapplication.h"
...
void GuiApplication::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (GuiApplication::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&GuiApplication::signOnSceneGraphInitializedDone)) {
                *result = 0;
                return;
            }
        }
