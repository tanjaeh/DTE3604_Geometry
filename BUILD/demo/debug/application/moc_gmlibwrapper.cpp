...
#include <memory>
#include "../../../../demo/application/gmlibwrapper.h"
...
void GMlibWrapper::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<GMlibWrapper *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (GMlibWrapper::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&GMlibWrapper::signFrameReady)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject GMlibWrapper::staticMetaObject = { {
    QMetaObject::SuperData::link<QObject::staticMetaObject>(),
    qt_meta_stringdata_GMlibWrapper.data,
    qt_meta_data_GMlibWrapper,
    qt_static_metacall,
    nullptr,
    nullptr
} };
