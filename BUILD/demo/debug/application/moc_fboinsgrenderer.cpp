...
#include <memory>
#include "../../../../demo/application/fboinsgrenderer.h"
...
void FboInSGRenderer::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<FboInSGRenderer *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (FboInSGRenderer::*)(const QString & , QKeyEvent * );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&FboInSGRenderer::signKeyPressed)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (FboInSGRenderer::*)(const QString & , QKeyEvent * );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&FboInSGRenderer::signKeyReleased)) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (FboInSGRenderer::*)(const QString & , QMouseEvent * );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&FboInSGRenderer::signMouseDoubleClicked)) {
                *result = 2;
                return;
            }
        }
        {
            using _t = void (FboInSGRenderer::*)(const QString & , QMouseEvent * );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&FboInSGRenderer::signMouseMoved)) {
                *result = 3;
                return;
            }
        }
        {
            using _t = void (FboInSGRenderer::*)(const QString & , QMouseEvent * );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&FboInSGRenderer::signMousePressed)) {
                *result = 4;
                return;
            }
        }
        {
            using _t = void (FboInSGRenderer::*)(const QString & , QMouseEvent * );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&FboInSGRenderer::signMouseReleased)) {
                *result = 5;
                return;
            }
        }
        {
            using _t = void (FboInSGRenderer::*)(const QString & , QWheelEvent * );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&FboInSGRenderer::signWheelEventOccurred)) {
                *result = 6;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject FboInSGRenderer::staticMetaObject = { {
    QMetaObject::SuperData::link<QQuickFramebufferObject::staticMetaObject>(),
    qt_meta_stringdata_FboInSGRenderer.data,
    qt_meta_data_FboInSGRenderer,
    qt_static_metacall,
    nullptr,
    nullptr
} };
